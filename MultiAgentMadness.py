...
user_proxy.initiate_chat(
    assistant,
    message="""Find a movie site that allows web scraping and has historical data. Get me the list of the top five movies for 2020, 2021, and 2022. Put the results in a word document called CoolMovies.docx """,
)
